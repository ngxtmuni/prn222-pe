    ...
    public class Program3000
    {
        ...
        private static void InitializeSampleData()
        {
            ...
            borrowRecords.AddRange(new[]
            {
                ...
                (2, 101, 1002, DateTime.Parse("2024-02-20"), null, "Borrowed"),

                (3, 101, 1003, DateTime.Parse("2024-01-10"), DateTime.Parse("2024-02-25"), "Overdue"),
                (4, 102, 1004, DateTime.Parse("2024-03-01"), DateTime.Parse("2024-03-15"), "Returned"),
                (5, 102, 1005, DateTime.Parse("2024-03-20"), null, "Borrowed"),
                (6, 103, 1001, DateTime.Parse("2024-04-01"), null, "Borrowed")
            });
